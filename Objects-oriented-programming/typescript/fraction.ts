/*
En este escenario, se te proporcionara varias fracciones y tu tarea sera realizar diversas
...
Dado la posibilidad de poder operar estas fracciones de 2 formas distintas, tanto de funciones aparte
...
const createFraction = (numerator: number, denominator: number): Fraction => {
    ...
    const createFractionwithFuntions = (numerator: number, denominator: number): FractionsWithOperations => {
    ...
    const f3 = createFractionwithFuntions(3,4)
